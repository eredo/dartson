...
// TODO how to register as listener to test runner instead of tracking tests?
var testsToRun = 3;
var testsRun = 0;
var testsOK = 0;
...
Future<bool> testSerializeAndDeserializePolymorphic(var dsonFactory) {
  ...
  group("polymorph", () {
    tearDown(() {
      ...
      if (testsRun == testsToRun) {
        completer.complete(testsToRun == testsOK);
      }
    });
